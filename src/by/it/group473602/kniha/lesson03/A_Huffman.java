...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (char symbol: s.toCharArray() )
        {
            if(!count.containsKey(symbol))
            {
                ...
                newValue = count.get(symbol);
                count.put(symbol, ++newValue);
            }
        }
        ...
        for(Map.Entry entry: count.entrySet()){
            LeafNode node = new LeafNode((int)entry.getValue(),(char)entry.getKey());
        ...
        while(priorityQueue.size()!=1)
        {
            ...
            InternalNode newInternalNode = new InternalNode(first, second);
            priorityQueue.offer(newInternalNode);
        }
        ...
        Node treeElement = priorityQueue.poll();
        treeElement.fillCodes("");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group473602/kniha/lesson03/dataHuffman.txt");
